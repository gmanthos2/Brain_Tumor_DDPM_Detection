...
Table~\ref{tab:anomaly_results} presents results for the best configuration identified through grid search: checkpoint \texttt{step\_100000}, $t_{\text{start}} = 150$, $w = 7.5$. This achieves an image-level AUROC of 0.756 and AUPRC of 0.851.
...
At the pixel level, the model achieves a pixel-level AUROC of \textbf{0.894}, indicating strong localization. Figure~\ref{fig:roc_curve} shows the pixel-level ROC curve, and Figure~\ref{fig:qualitative} presents a qualitative example.
